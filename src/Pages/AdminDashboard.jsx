...
const AdminDashboard = () => {
   ...
   return (
      ...
      {window.screen.width<=3000 && window.screen.width>=1000 ? 
         <Sidebar />
      :""
      }
    
         <DIV className="product-container">
            <Text className="text-male" fontSize="40px" color="black">
               {""}
            </Text>
            <div className="total-sort-conatiner">
               ...
               <Text className="text-cat" fontSize="30px" color="gray">
                  {getDataCategoryLS.charAt(0).toUpperCase() +
                     getDataCategoryLS.slice(1)}
               </Text>

      ...
      <MAINDIV>
         <div className="filterSection">
            <div
               ...
               style={{
                  color: current === "all" ? "white" : "black",
                  background: current !== "all" ? "white" : "black",
               }}
            >
               All
            </div>
            <div
               ...
               style={{
                  color: current === "new" ? "white" : "black",
                  background: current !== "new" ? "white" : "black",
               }}
            >
               NEW ARRIVALS
            </div>
            <div
               ...
               style={{
                  color: current === "best" ? "white" : "black",
                  background: current !== "best" ? "white" : "black",
               }}
            >
               BEST SELLERS
            </div>
            <div
               onClick={() => handleChange("flash")}
               style={{
                  color: current === "flash" ? "white" : "black",
                  background: current !== "flash" ? "white" : "black",
               }}
            >
               FLASH SALE
            </div>

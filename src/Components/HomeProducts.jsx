...
export const HomeProduct = ( ) =>{
    ...
    const [homeData, setData] = useState(all)
    ...
    return <MAINDIV>
         <div className="filterSection">
            <div onClick={()=>handleChange("all")} style={{ color : current === "all" ? "white" : "black" , background : current !== "all" ? "white" : "black"}}  >All</div>
            <div onClick={()=>handleChange("new")} style={{ color : current === "new" ? "white" : "black" , background : current !== "new" ? "white" : "black"}}>NEW ARRIVALS</div>
            <div onClick={()=>handleChange("best")}  style={{ color : current === "best" ? "white" : "black" , background : current !== "best" ? "white" : "black"}}>BEST SELLERS</div>
            <div onClick={()=>handleChange("flash")}  style={{ color : current === "flash" ? "white" : "black" , background : current !== "flash" ? "white" : "black"}}>FLASH SALE</div>
        </div>
         <PRODUCTS>
       
        {homeData.map((el,index)=>(
            <HomeProductCart key={index} id={el.id} title={el.title} price= {el.price} image={el.image} />
        ))}
